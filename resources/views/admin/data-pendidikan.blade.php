                                ...
                                <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form method="POST" action="{{ route('admin.pendidikan.store') }}">
                                                {{ csrf_field() }}
                                                <div class="mb-3 row">
                                ...
                                <tbody>
                                    @foreach ($pendidikan as $item)
                                            ...
                                            <div class="modal-dialog modal-lg">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form method="POST"
                                                            action="{{ route('admin.pendidikan.update', $item->id) }}">
                                                            {{ csrf_field() }}
                                                            <div class="mb-3 row">
                                                                <label class="col-sm-3 col-form-label f-w-600"
                                                                    for="id">Nama</label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('admin.pendidikan.delete', $item->id) }}"
                                                    class="btn btn-danger">Hapus</a>
                                                <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                                    onclick="update(`{{ $item->tahun_masuk }}`,`{{ $item->tahun_keluar }}`)"
